                            ...
                            <li class="collection-item">
                                     <div class="row">
                                  	...
                                  	<%if(rs.getString("status").equalsIgnoreCase("yet to be delivered")){ %>
										...
										<button class="btn waves-effect waves-light right submit" type="submit" name="processing">Processing
								...
								<%}	%>
									...
									<input id="remark" name="remark" type="text" data-error=".errorTxt01" ">
