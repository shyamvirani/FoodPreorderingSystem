...
if((String)session.getAttribute("user")==null)
	...
	rs.next();
	int i=0;
	query = "select * from tblorder where fkcanteen_id = "+rs.getString("pkcanteen_id")+" order by pkorder_id desc";
		        ...
		        <h4 class="panel-title">
					...
					<li class="collection-item avatar" >
                             ...
                             <td>
							  ...
							  <td>					  
                              		<p><strong>Status:</strong><%=allorder.status %></p>							  
							 	</td>

							  <tr>
							  <td></td>
							  <td>	 <p><strong>Price:</strong><%=allorder.totalPrice %></p></td>
							  <td>									  				 
