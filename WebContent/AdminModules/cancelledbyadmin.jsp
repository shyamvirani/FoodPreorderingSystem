          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Orders cancelled by Admin</h5>
              </div>
            </div>
          </div>
        </div>
...
if((String)session.getAttribute("user")==null)
	...
	rs.next();
	int i=0;
	query = "select * from tblorder where fkcanteen_id = "+rs.getString("pkcanteen_id") +" and status = 'cancelled by admin' order by pkorder_id desc";
		     ...
		     <div class="panel-heading" style="background-color:#e6e6e6">
              ...
              <div class="col s12 m4 l3">
 				<h4 class="header">Order details
                	<a class="btn cyan waves-effect waves-light right" href="singleorder.jsp?oid=<%=temp.orderId %>">View More
