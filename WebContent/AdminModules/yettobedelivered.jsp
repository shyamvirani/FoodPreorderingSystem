          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><b>Orders:</b> yet to be delivered</h5>
              </div>
            </div>
          </div>
        </div>
...
if((String)session.getAttribute("user")==null)
	...
	rs.next();
	int i=0;
	query = "select * from tblorder where fkcanteen_id = "+rs.getString("pkcanteen_id") +" and status = 'yet to be delivered' or status='processing' order by pkorder_id desc";
